...
<body>
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-12 pb-4">
                            <button class="btn btn-success" data-toggle="modal" data-target="#modal_new_vehiculo"><i class="fas fa-plus-square"></i> Agregar Vehiculo</button>
                            ...
                            <a href="../../reportes/lista_vehiculos_pdf.php" class="btn btn-warning"><i class="fas fa-file-pdf"></i> Generar PDF</a>
                        </div>
                        ...
                        <div style="overflow-x: auto;">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php
                                        $query = $obj->lista_vehiculo('habilitados');
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="btn btn-warning" data-toggle="modal" data-target="#modal_mod_vehiculo"
                                            onclick="rellenar_mod_vehiculo(<?php echo $id;?>,'<?php echo $matricula;?>','<?php echo $marca;?>','<?php echo $modelo;?>')">
                                            modificar
                                            </button>
                                        </td>
                                        <td>
                                            <button class="btn btn-danger" onclick="estado_vehiculo(<?php echo $id;?>,'eliminar')">eliminar</button>
                                        </td>
                                    </tr>
        ...
        <div class="modal fade" id="modal_mod_vehiculo" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="#" id="form_mod_vehiculo">
                            <div>
                                <span class="text-danger">Los campos marcados con (*) son obligatorios</span>
                            </div>
                            
                            <input type="hidden" name="mod_id_vehiculo" id="mod_id_vehiculo">

                            <div class="form-group">
                                <label for="mod_matricula">Matricula(*):</label>
                                <input type="text" class="form-control" id="mod_matricula" name="mod_matricula" placeholder="Ingrese la Matricula" maxlength=10>
                            </div>

                            <div class="form-group">
                                <label for="mod_marca">Marca(*):</label>
                                <input type="text" class="form-control" id="mod_marca" name="mod_marca" placeholder="Ingrese la Marca" maxlength=20>
                            </div>

                            <div class="form-group">
                                <label for="mod_modelo">Modelo(*):</label>
                                <input type="text" class="form-control" id="mod_modelo" name="mod_modelo" placeholder="Ingrese el Modelo" maxlength="20">
                            </div>

                            <p class="text-danger" id="msg_error_modvehiculo"></p>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark" data-dismiss="modal">Cancelar</button>
                        <button type="button" id="btnguardar" class="btn btn-success" onclick="mod_vehiculo()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal_new_vehiculo" tabindex="-1" role="dialog" aria-labelledby="modal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <form action="#" id="form_new_vehiculo">
                            <div>
                                <span class="text-danger">Los campos marcados con (*) son obligatorios</span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="matricula" name="matricula" placeholder="Ingrese la Matricula" maxlength=10>
                            </div>

                            <div class="form-group">
                                <label for="marca">Marca(*):</label>
                                <input type="text" class="form-control" id="marca" name="marca" placeholder="Ingrese la Marca" maxlength=20>
                            </div>

                            <div class="form-group">
                                <label for="modelo">Modelo(*):</label>
                                <input type="text" class="form-control" id="modelo" name="modelo" placeholder="Ingrese el Modelo" maxlength="20">
                            </div>

                            <p class="text-danger" id="msg_error_newvehiculo"></p>
                        </form>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-dark" data-dismiss="modal">Cancelar</button>
                        <button type="button" id="btnguardar" class="btn btn-success" onclick="new_vehiculo()">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="overflow-x: auto;">
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                    $query=$obj->lista_vehiculo('deshabilitados');
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $modelo;?></td>
                                    <td>
                                    <button class="btn btn-success" id="btnhab" onclick="estado_vehiculo(<?php echo $id;?>,'habilitar')">Habilitar</button>
                                    </td>
                                </tr>
                                <?php
                                    }
    ...
    <script src="../../recursos/js/vehiculo.js"></script>
