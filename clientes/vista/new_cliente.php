                    ...
                    <form id="regisper" action="../controlador/resp_newemp.php" method="POST" class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" class="form-control" id="nom_fiscal" name="nom_fiscal" placeholder="Ingrese el nombre fiscal" maxlength=35>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-5 col-sm-2">
                                    <select class="form-control" name="tipo_rif" id="tipo_rif">
                                ...
                                <div class="col-7 col-sm-10">
                                    <input type="text" class="form-control" id="rif" name="rif" pattern="[0-9]" placeholder="Ingrese la rif" maxlength=9 onkeypress="return numeros(event);">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <select class="form-control" name="id_zona" id="id_zona">
                                        <option value="0" hidden>Selecciona una zona urbana</option>
                                        <?php
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <textarea class="form-control" name="direccion" id="direccion" cols="20" rows="5" maxlenght=250 placeholder="Ingrese la direccion del cliente"></textarea>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="btnguardar" class="btn btn-success" onclick='regiscli()'>Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
