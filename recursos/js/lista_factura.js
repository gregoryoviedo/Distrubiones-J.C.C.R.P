...
$('#form_buscar').submit(function(event){
    ...
    var enlace = 'historial_factura.php?busqueda='+buscar+'&p=1';
...
function siguiente(busqueda,pag_actual){
    ...
    var enlace = 'historial_factura.php?busqueda='+busqueda+'&p='+pagina;
    window.location.href = enlace;
}
...
function imprimir(){
    var id_factura = $('#id_fact_imprimir').val();
    var enlace = '../../reportes/factura_pdf.php?id_factura='+id_factura;
    window.location.href = enlace;    
}