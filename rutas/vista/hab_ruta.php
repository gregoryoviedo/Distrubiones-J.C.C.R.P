...
<head>
    ...
    $id_ruta = $_GET['ruta'];
    $ficha1 = $obj->llenarficha($_GET['emp1']);
    $ficha2 = $obj->llenarficha($_GET['emp2']);
  ...
  <div class="page-wrapper default-theme sidebar-bg toggled bg-light">
    ...
    <main class="page-content pt-2">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12">
                        <h1>Habilitar Ruta</h1>
                        <hr>
                        
                    </div>
                    
                    <div class="col-lg-12">
                    <form id="modruta" action="#" method="POST" class="container">
                        <!-- TITULO PRINCIPAL -->
                        <div>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12">
                                    <select class="form-control" name="vendedor1" id="vendedor1">
                                        <option value="<?php echo $id_empleado;?>" hidden><?php echo $apellido.', '.$nombre;?></option>
                                        <?php
                                ...
                                <div class="form-group mt-4">
                                    <div class="row">
                                        <div class="col-4 text-center">
                                            <img src="../../recursos/img/fotos_perfil/<?php echo $urlfoto;?>" alt="foto_vendedor" width=150px height=200px>
                                        </div>
                                        <div class="col-8">
                                            <div class="row">
                                                <div class="col-12">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" >¿Desea habilitar la ruta?</h5>
                                    </div>
                                    
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-dark" data-dismiss="modal">Cancelar</button>
                                        <button type="button" id="btnguardar" class="btn btn-success" onclick='hab_ruta()'>Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
