                                ...
                                <div class="form-group mt-4">
                                    <div class="row">
                                        <div class="col-4 text-center">
                                            <img src="../../recursos/img/fotos_perfil/<?php echo $urlfoto;?>" class="foto_empleado_ruta" alt="foto_vendedor" width=150px height=200px>
                                        </div>
                                        <div class="col-8">
                                            <div class="row">
                                                <div class="col-12">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button type="button" id="btnguardar" class="btn btn-success" onclick='mod_ruta()'>Guardar</button>
                                    </div>
                                </div>
                            </div>
                        </div>
