...
<body>
    <div class="page-wrapper default-theme sidebar-bg bg1 toggled">
        ...
        <main class="page-content pt-2">
            <div class="container-fluid">
                <div class="row">
                   ...
                   <div class="col-12 pb-4">
                       <a href="../../reportes/historial_factura_pdf.php?busqueda=<?php echo $busqueda?>" class="btn btn-warning"><i class="fas fa-file-pdf"></i> Imprimir Lista PDF</a>
                    </div>
                </div>
                ...
                <div class="col-12" style="overflow-x: auto;">
                        ...
                        <?php
                            ...
                            $query = $obj->historial_factura($busqueda,$pagina,10);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <button class="btn btn-info" data-toggle="modal" data-target="#fact_completa" onclick="cargar_fact(<?php echo $row['id_factura'];?>)"><i class="fas fa-eye"></i> Ver mas</button>
                                    </td>
                                </tr>
                            <?php
                            }
            ...
            <div class="modal fade" id="fact_completa" tabindex="-1" role="dialog" aria-labelledby="lista_deshabilitadosTitle" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="titulo_modal">Factura</h5>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-warning" onclick="imprimir();"><i class="fas fa-file-pdf"></i> Imprimir PDF</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../../recursos/js/lista_factura.js"></script>
