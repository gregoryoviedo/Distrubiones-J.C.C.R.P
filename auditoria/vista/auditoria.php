...
<head>
    ...
    require('../modelo/auditoria.class.php');
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                   ...
                   <div class="col-12 pb-4">
                       <a href="../../reportes/auditoria_pdf.php?busqueda=<?php echo $busqueda;?>" class="btn btn-warning"><i class="fas fa-file-pdf"></i> Imprimir Lista PDF</a>
                    </div>
                </div>
                ...
                <div class="col-12" style="overflow-x: auto;">
                        ...
                        <?php
                            ...
                            $query = $obj->lista_auditor($busqueda,$pagina,10);
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><img src="../../recursos/img/fotos_perfil/<?php echo $row['urlfoto'];?>" width=40px heigth=60px alt="pp"></td>
                                    <td><?php echo $row['nombre'].' '.$row['apellido'];?></td>
                                    <td><?php echo $row['user_sis'];?></td>
    ...
    <script src="../../recursos/js/lista_auditor.js"></script>
